...
class Character:
    ...
    def get_system_prompt(self) -> str:
        ...
        return (
            ...
            f"1. You may ONLY write the WORDS {self.name} speaks out loud\n"
            f"2. NEVER write: 'I pause', 'I stand up', 'I say', 'my voice', etc.\n"
            f"3. NEVER use: asterisks, parentheticals, stage directions\n"
            f"4. The narrator describes actions - you only provide spoken words\n\n"
            f"CORRECT examples (pure dialogue only):\n"
            f"✓ \"Marcus, what triggered the lockdown? My daughter is expecting my call.\"\n"
            f"✓ \"Wait - someone accessed my files at 9:23 PM, before the breach.\"\n"
            f"✓ \"Are you seriously suggesting I compromised my own research?\"\n\n"
            f"WRONG examples (includes actions/descriptions):\n"
            f"✗ I pause, then say \"Marcus, what triggered the lockdown?\"\n"
